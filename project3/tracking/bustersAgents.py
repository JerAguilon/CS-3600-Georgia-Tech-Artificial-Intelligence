    ...
    def chooseAction(self, gameState):
        ...
        for dist in livingGhostPositionDistributions:
            ...
            for k, v in dist.items():
                if bestVal is None or bestVal[1] < v:
                    bestVal = (k,v)
            ghostMaxes.append(bestVal)
        ...
        # print(ghostMaxes)
        for index, item in enumerate(ghostMaxes):
            currPrb = livingGhostPositionDistributions[index][item[0]]
            if currPrb >= bestPrb:
                bestCoord = item[0]
                bestPrb = currPrb
        ...
        for a in legal:
            ...
            currDist = self.distancer.getDistance(successor, bestCoord)
